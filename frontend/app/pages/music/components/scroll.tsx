...
export default function MusicScroll() {
    ...
    const currentLimit = Number(searchParams.get('music_limit') || '50');
    ...
    const handleScroll = useCallback(() => {
        ...
        if (scrolledToBottom) {
            ...
            params.set('music_limit', newLimit.toString());
    ...
    return (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 animate-in fade-in slide-in-from-bottom-4 duration-300">
            <div className="bg-background/80 backdrop-blur-md border border-border/50 text-foreground px-6 py-3 rounded-full shadow-2xl flex items-center gap-3">
                ...
                <span className="text-sm font-medium tracking-wide">Henter flere sange...</span>
            </div>
        </div>
    ); 
}
